...
/* USER CODE BEGIN EV */
uint8_t sendData[4] = {1,2,3,4}; // Example data to send
uint8_t receiveData;
uint8_t byteIndex = 0;
/* USER CODE END EV */
...
//  }
//  else if(receiveData[1]==2 && receiveData[0]==1){
//	  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_15, SET);
//	  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_14, SET);
//  }
//  else if(receiveData[2]==3 && receiveData[1]==2 && receiveData[0]==1){
//	  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_15, SET);
//	  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_14, SET);
//	  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_13, SET);
//  }
//  else if(receiveData[3]==4 && receiveData[2]==3 && receiveData[1]==2 && receiveData[0]==1){
//	  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_15, SET);
//	  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_14, SET);
//	  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_13, SET);
